/*
  mh440_uart.h - MH-Z19 CO2 sensor library for ESP-WROOM-02/32(ESP8266/ESP32) or Arduino
  version 0.3
  
  License MIT
*/

#ifndef mh440_uart_h_
#define mh440_uart_h_
...
private:
	uint8_t mh440_checksum(uint8_t com[]);
	void readSerialData();
